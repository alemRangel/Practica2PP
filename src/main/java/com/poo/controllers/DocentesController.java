...
public class DocentesController extends UniversidadController{
    ...
    public void addDocente(){
        ...
        Persona persona;
        FechaCont fechaCont;
        ModalidadDocente ModalidadDocente;
        ...
        do{
            ...
            switch(opcModalidadValida){
                case 1:
                    ModalidadDocente = ModalidadDocente.Presencial;
                    break;
                case 2:
                    ModalidadDocente = ModalidadDocente.Distancia;
                    break;
                case 3:
                    ModalidadDocente = ModalidadDocente.Mixta;
                    break;
                default:
